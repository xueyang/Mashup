...
module.exports = function(RED) {
    ...
    function HTTPRequest(n) {
        ...
        var title = encodeURI(n.title);

        var nodeUrl = "http://apis.baidu.com/showapi_open_bus/channel_news/search_news?channelname=" + channelname + "&title=" + title;
    ...
    RED.nodes.registerType("news",HTTPRequest,{
        credentials: {
            user: {type:"text"},
