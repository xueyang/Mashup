...
module.exports = function(RED) {
    ...
    function HTTPRequest(n) {
        ...
        var location = n.longitude + encodeURI(",") + n.latitude+encodeURI(";");
        var radius = n.radius;

        var nodeUrl = "http://apis.baidu.com/apistore/location/near?keyWord=" + keyword + "&location=" + location + "&radius=" + radius+"&number=20&page=1&output=json";
    ...
    RED.nodes.registerType("locationnear",HTTPRequest,{
        credentials: {
            user: {type:"text"},
