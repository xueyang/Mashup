...
module.exports = function(RED) {
    ...
    function HTTPRequest(n) {
        ...
        var nodeUrl = "http://apis.baidu.com/apistore/weatherservice/recentweathers?cityname=" + city;
        ...
        this.on("input",function(msg) {
            ...
            var req = ((/^https/.test(urltotest))?https:http).request(opts,function(res) {
                ...
                res.on('end',function() {
                    ...
                    msg.weather = msg.payload.retData.forecast[0].type;
                    msg.temp_max = parseInt(msg.payload.retData.forecast[0].hightemp);
                    msg.temp_min = parseInt(msg.payload.retData.forecast[0].lowtemp);
                    node.send(msg);
                    node.status({});
                });
            });
    ...
    RED.nodes.registerType("weather",HTTPRequest,{
        credentials: {
            user: {type:"text"},
