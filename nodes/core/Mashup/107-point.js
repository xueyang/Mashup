...
module.exports = function(RED) {
    ...
    function HTTPRequest(n) {
        ...
        var keyword = encodeURI(n.keyword);
        var cityname = encodeURI(n.cityname);

        var nodeUrl = "http://apis.baidu.com/apistore/point/search?keyWord=" + keyword + "&cityName=" + cityname + "&number=10&page=1&output=json";
    ...
    RED.nodes.registerType("point",HTTPRequest,{
        credentials: {
            user: {type:"text"},
